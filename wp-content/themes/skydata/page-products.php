 ...
 */
/*
Template name: Main Products Detaill
*/
?>
            ...
            <div class="col-md-9 animate fadeInRight">
	            <?php if(get_field('imagen')):?>
                    <div class="single-item-carousel classic-arrows2 owl-carousel">
                        <img src="<?php the_field('imagen');?>" alt="<?php the_field('titulo') ?>">
                    </div>
	            <?php endif; ?>
                                ...
                                <?php if( have_rows('prod') ): ?>
                                    <?php while( have_rows('prod') ): the_row();?>
                                        <?php if ( get_row_layout() == 'bloque' ): ?>
                                            ...
                                            <div class="boxgrid_col">
                                                <div class="boxgrid slideright">
                                                    <img class="cover" src="<?php the_sub_field('imagen'); ?>"/>
                                                    <p><?php the_sub_field('descripcion'); ?></p>
                                                </div>
                                                <span class="text-center col-lg-12 boxgrid_sapn"><?php the_sub_field('titulo'); ?></span>
                                            </div>
                                        <?php endif; ?>
                                    <?php endwhile; ?>
                                <?php endif; ?>
