...
<section>
	<div class="container">
		<div class="row">
            <div class="animaete fadeInLeft col-md-12">
                <div class="sidebar-widget">
                    <div class="search clearfix">
                        <form method="get" action="">
                            <input onkeyup="$('#formsearch').val($('#valuesearch').val())" id="valuesearch" type="text" placeholder="Buscar..." value="<?= $valor ?>">
                ...
                if($valor != ''):
					if ( $myposts ) :
						foreach ( $myposts as $post ) :
							...
							<article class="blog-item col-md-3">
